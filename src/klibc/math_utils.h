 ...
 * and `rem` instructions away.
 *
 * @param a             The dividend.
 * @param power_of_two  The exponent of the power-of-two divisor; i.e., the
 * divisor is 2^power_of_two.
 *
 * WARNING: `power_of_two` must not exceed the number of bits in `u_long`, i.e.
 * `sizeof(u_long) * CHAR_BIT`. Values beyond the bit width of `u_long` are
 * invalid.
 */
