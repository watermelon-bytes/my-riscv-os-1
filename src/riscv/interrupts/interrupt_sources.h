...
#define RISCV_ALL_INTR_SOURCES_ON                           \
    (INTSRC_MACHINE_EXTERNAL | INTSRC_MACHINE_TIMER |       \
     INTSRC_MACHINE_SOFTWARE | INTSRC_SUPERVISOR_EXTERNAL | \
     INTSRC_SUPERVISOR_SOFTWARE | INTSRC_SUPERVISOR_SOFTWARE)
